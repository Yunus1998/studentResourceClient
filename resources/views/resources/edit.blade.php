...
@section('content')
    ...
    <a href="{{route('students')}}" style="margin-top: 70px;margin-bottom: 20px;" CLASS="col-lg-offset-3 col-lg-6 btn btn-default">View all Students resource</a>
                    
    <form role="form" action="{{route('student.update', $id)}}">
        ...
        <div class="box-body">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary col-lg-4 col-lg-offset-1">Update Student</button>
                    <a href="{{route('student.delete', $id)}}" class="btn btn-danger col-lg-4 col-lg-offset-1">Delete Student</a>
